package com.example.currencyi.thirdFragment
...
import com.example.currencyi.dialog.BottomSheetDialog
import com.example.currencyi.dialog.FirstDialogCallBack
import com.example.currencyi.dialog.FirstDialogFragment
import com.example.currencyi.dialog.SelectCurrencyBottomSheet
...
class ThirdFragment : Fragment(R.layout.third_fragment), ItemTouchDelegate, FirstDialogCallBack, BottomSheetDialog.NewBottomSheet {
    ...
    override fun addItemFromBottomSheet(
        ...
        var newCurrencyAdd = Currency(typeCurrencyType.text.toString(), Integer.parseInt(typeCurrencyCost.text.toString()), 1, res)
